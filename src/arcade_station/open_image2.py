...
if __name__ == "__main__":
    ...
    use_default = "--default" in sys.argv or "--true" in sys.argv or "--True" in sys.argv
    display_image_from_config(use_default=use_default)  # Now properly passes the CLI arg