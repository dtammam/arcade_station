...
def main():
    ...
    try:
        ...
        parser.add_argument(
            "background_color", help='Background color (e.g., "black", "#000000")'
        )
        parser.add_argument(
            "monitor_index", type=int, help="Index of the monitor to display on"
        )
        parser.add_argument(
            "--identifier", default="marquee_image", help="Process identifier"
        )
