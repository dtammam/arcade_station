...
class InstallLocationPage(BasePage):
    ...
    def __init__(self, container, app):
        ...
        self.set_title(
            "Installation Location", "Choose where to install Arcade Station"
        )
    ...
    def create_widgets(self):
        ...
        default_label = ttk.Label(
            location_frame, text=message, wraplength=500, justify="left"
        )
        ...
        browse_button = ttk.Button(
            path_frame, text="Browse...", command=self.browse_location
        )
        browse_button.pack(side="right")

        # Space requirements
        requirements_frame = ttk.LabelFrame(
            location_frame, text="Requirements", padding=(10, 5)
        )
    ...
    def browse_location(self):
        ...
        selected_dir = filedialog.askdirectory(
            title="Select Installation Directory", initialdir=initial_dir
        )
    ...
    def validate(self):
        ...
        if not path:
            messagebox.showerror(
                "Invalid Path", "Please enter a valid installation path."
            )
            return False
        ...
        if not os.path.isdir(path):
            try:
                ...
                messagebox.showerror(
                    "Permission Error", f"Cannot create directory: {e}"
                )
                return False
        ...
        try:
            ...
            messagebox.showerror(
                "Permission Error", f"Cannot write to the selected directory: {e}"
            )
            return False
    ...
    def save_data(self):
        ...
        try:
            ...
            status_label = ttk.Label(
                progress_window, text="Preparing...", wraplength=380, justify="center"
            )
